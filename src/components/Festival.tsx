...
import { Box, Flex, Text, Heading, HStack } from '@chakra-ui/core'
...
const Festival: React.FC = () => {
    return (
        <Flex w="100%" minH="100vh" direction="column" wrap="nowrap">
            ...
            <Container>
                <Box flex="0 0 100%">
                    <Heading as={Textfit} color="green" textAlign="center" textTransform="uppercase"  mode="single" forceSingleModeWidth={true} max={9999}>
                        Artimañas
                    </Heading>
                </Box>
                <HStack spacing="1rem" align="stretch" justify="space-between">
                    ...
                    <Flex direction="row" wrap="wrap" flex="0 0 calc(33.33% - 1rem)">
                        <Box flex="0 0 100%" h="fit-content" align-self="flex-start" >
                            <Heading as={Textfit} color="magenta" textAlign="center" lineHeight={0.8} textTransform="uppercase" max={9999} mode="single" forceSingleModeWidth={true}>20</Heading>
                        </Box>
